    ...
    <div class="content">
        <div class="card">
            <div class="card-title">
                <h2><i class="fa fa-external-link"></i> &nbsp;Edit Company</h2>
            </div>
        </div>
        <div class="cardbox">
            <form method="post" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="input" id="validationCustom03" value="<?php echo $row['CompanyName'];?>" name="companyname" required>
                </div>
                <br>
               <?php } ?>                                 
