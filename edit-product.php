    ...
    <div class="content">
        <div class="card">
            <div class="card-title">
                <h2><i class="fa fa-external-link"></i> &nbsp;Edit Product</h2>
            </div>
        </div>
        <div class="cardbox">
            ...
            <?php
                ...
                <div class="form-group">
                    <div class="company-label">
                        <label class="categoryname">Company</label>
                    </div>
                ...
                <div class="form-group">
                    <div class="company-label">
                        <label class="categoryname">Product Name</label>
                    </div>
                    <input type="text" class="input" id="validationCustom03" value="<?php echo $result['ProductName'];?>" name="productname" required>
                </div>
                <br>
                <div class="form-group">
                    <div class="company-label">
                        <label class="categoryname">Product Price</label>
                    </div>
                    <input type="text" class="input" id="validationCustom03" value="<?php echo $result['ProductPrice'];?>" name="productprice" required>
                </div>
                <?php } ?>
                <br><br>
