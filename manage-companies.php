...
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a href=""><i class="fa fa-file-text"></i><span>Manage Company</span></a>
        ...
        <div class="content">
            <div class="cardbox">
                <div class="card-title">
                    <h2><i class="fa fa-database"></i> &nbsp;Manage Companies</h2>
                </div>
            </div>
            <div class="cardbox">
                <form>
                        ...
                        <table id="myTable">
                            <tr>
                                ...
                                <?php
                                    ...
                                    <td>
                                    <a href="edit-company.php?compid=<?php echo base64_encode($row['id'].$rno);?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"><i class="fas fa-edit"></i></a>&nbsp;
                                    <a href="manage-companies.php?del=<?php echo base64_encode($row['id'].$rno);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="fa fa-trash txt-danger"></i> </a>
                                    </td>
                                    </tr>
                                    <?php 
                                    $cnt++;
