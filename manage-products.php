...
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a href=""><i class="fa fa-list-alt"></i><span>Manage Product</span></a>
        ...
        <div class="content">
            <div class="cardbox">
                <div class="card-title">
                    <h2><i class="fa fa-database"></i> &nbsp;Manage Products</h2>
                </div>
            </div>
            <div class="cardbox">
                <form>
                        ...
                        <table id="myTable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="edit-product.php?pid=<?php echo base64_encode($row['id'].$rno);?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <?php 
                                $cnt++;
