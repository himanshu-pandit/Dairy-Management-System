                ...
                <div class="form-group"> 
                    ...
                    {?>
                        <div class="col-md-5 mb-20">
                            <div>
                                <span><b>Date: </b><?php echo $row['InvoiceGenDate'];?></span>
                            </div>
                            <div>
                                <span><b>Invoice/Receipt No: </b><?php echo $row['InvoiceNumber'];?></span>
                            </div>
                            <div>
                                <span><b>Customer Name: </b><?php echo $row['CustomerName'];?></span>
                            </div>
                            <div>
                                <span><b>Customer Mobile No: </b><?php echo $row['CustomerContactNo'];?></span>
                            </div>
                            <div>
                                <span><b>Payment Mode: </b><?php echo $row['PaymentMode'];?></span>
                            </div>
                        </div>
                    <?php break;} ?>
                    <hr class="mt-0">
                    ...
                    <div class="table-wrap">
                        <table class="table mb-0" border="1">
                            ...
                            <?php 
                            //Product Details
                            $query=mysqli_query($con,"select tblproducts.CategoryName,tblproducts.ProductName,tblproducts.CompanyName,tblproducts.ProductPrice,tblorders.Quantity  from tblorders join tblproducts on tblproducts.id=tblorders.ProductId where tblorders.InvoiceNumber='$inid'");                                        $cnt=1;
                            while($row=mysqli_fetch_array($query))
                            {    
                            ?>                                                
                            <tr>
